...
#Make sure to enter the name and case exactly as above and enter the place_id and your Python code below. Hint: The first seven characters of the place_id are "ChIJ9zg ..."
...
while True:
    ...
    parms = dict()
    parms['address'] = address                                    # Assigning address to parms dictionary
    if api_key is not False: parms['key'] = api_key               # Assigning api_key var to key (key) in dictionary
    ...
    try:
        js = json.loads(data)                                    # If loading data from the json fails the data file will be assumed as none
    except:
        js = None
